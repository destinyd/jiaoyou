class UserDetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_detail.save
        format.html { redirect_to(@user_detail, :notice => 'UserDetail was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @user_detail.update_attributes(params[:user_detail])
        format.html { redirect_to(@user_detail, :notice => 'UserDetail was successfully updated.') }
        format.xml  { head :ok }
      else
